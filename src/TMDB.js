...
class TMDB{
  ...
  static MovieDetailEpisodeEndpoint( movieId, seasonNumber, episodeNumber ){
    return 'https://api.themoviedb.org/3/tv/'+movieId+'/season/'+seasonNumber+'/episode/'+episodeNumber+'?api_key='+API_KEY+'&language=en-US';
  }
}
